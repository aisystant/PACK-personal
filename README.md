...
Обычно подключается как **зависимость PACK-rhetoric**: карточки приёмов ссылаются на концепты отсюда (характеристики, роли, состояния созидателя).

**Что здесь искать (примеры запросов агенту):**
- «Что такое состояние собранности — найди определение в паке о созидателе»
- «Какие характеристики созидателя формализованы?»
- «Найди типичные ошибки интерпретации „мотивации"»

**Чего здесь нет:** приёмов подачи и программ обучения — это PACK-rhetoric и PACK-MIM.
