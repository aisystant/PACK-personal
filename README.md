...
|-----------|------|------------|
| **Шаблон pack** | `/pack/_template/` | Универсальная структура для pack **любого** домена |
| **Pack «Личное развитие»** | `/pack/personal-development/` | Конкретный pack с MVP-контентом |
| **Процесс создания** | `/process/` | Как создавать, наполнять и поддерживать pack |
| **Спецификации** | `/spec/` | Интерфейсы для downstream-потребителей |
| **Зависимость FPF** | `/fpf/` | Связь с First Principles Framework |
| **Конституция** | `CLAUDE.md` | Правила работы с репозиторием |

Таким образом, репозиторий — это одновременно:
1. **Фреймворк** для создания pack любой области знаний
2. **Конкретный pack** для домена «Личное развитие»
