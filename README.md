...
**Репозиторий содержит SPF (Second Principles Framework) и один доменный Pack — Personal Development**
...
2. **Pack «Personal Development»** — один конкретный pack, реализованный с помощью SPF
   - Доменное знание о личном развитии (методы, различения, failure modes и т.д.)

**Кратко**:
- `SPF` = фреймворк (универсален по форме)
- `Pack` = контент (специфичен по домену)
- Этот репо = SPF + один pack (PD)
...
SPF (Level 2 framework)  →  процесс и структура производства pack'ов
       ↓
Pack (Level 2 content)   →  доменное знание (здесь: личное развитие)
       ↓
...
### Pack: Personal Development (в этом репо)
| Файл | Назначение |
|------|------------|
