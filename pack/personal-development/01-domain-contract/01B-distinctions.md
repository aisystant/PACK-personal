...
| [D.140](#d140-characteristic-vs-measure-vs-potential) | Characteristic vs. Measure vs. Potential (Характеристика ≠ Показатель ≠ Потенциал) | current | D.139, FORM.088, FORM.038 |
...
| Человек как агент-создатель | | Скорость обучения, автономность, выносливость, креативность |
...
### D.140: Characteristic vs. Measure vs. Potential (Характеристика ≠ Показатель ≠ Потенциал) {#d140-characteristic-vs-measure-vs-potential}

| Characteristic (Характеристика) | Measure (Показатель) | Potential (Потенциал) |
|---|---|---|
| Свойство системы как аспект внимания | Текущее значение на шкале характеристики | Границы шкалы — куда можно развить показатель |
| Скорость обучения | «Осваиваю новую технологию за 2 дня» | «Могу довести до 1 дня через развитие интеллекта» |
| Выносливость | «Бегу 10 км без остановки» | «Могу довести до 42 км через тренировки» |
| Что существует (качественно) | Что есть сейчас (количественно) | Что возможно (границы) |

**Distinction Test:**
- «Это текущее значение или свойство в целом?» — показатель или характеристика
- «Это фактическое значение или верхняя граница шкалы?» — показатель или потенциал

**Typical Confusion:** «У меня низкая скорость обучения» — **это показатель, а не характеристика**. Характеристика (скорость обучения) есть у всех, различаются **показатели**. И вопрос не «есть ли у меня характеристика», а «какой текущий показатель и каков потенциал его повысить». Путаница ведёт к фиксированному мышлению («я такой»), вместо установки на рост («показатель можно сдвинуть, шкалу можно расширить»).

**Why It Matters (ключевой ход программы ЛР):**
1. **Показатель** двигается текущими усилиями (тренировка, практика, методы) — это работа Мастерства (M1-M4 из FORM.080 §3.1)
2. **Потенциал** расширяется через долгосрочное фундаментальное развитие — системное мышление (M4), интеллектуальные практики. Потенциал = не данность, а результат инвестиций.
3. У человека, в отличие от машины, **потенциал расширяется в течение жизни.** Автомобиль с мотором 200 км/ч быстрее не поедет. Человек с «показателем интеллекта» X может расширить шкалу до Y через фундаментальное образование и системное мышление.
4. **Программа ЛР работает на двух горизонтах:** краткосрочно — двигает показатели (M1 методы собранности); долгосрочно — расширяет потенциал (M4 системное мышление). Ступени 1→3 про показатели; ступени 3→5 про расширение потенциала.

**Analogy:** Автомобиль — потенциал двигателя фиксирован (200 км/ч — потолок). Человек — потенциал **расширяемый**: мышление растёт от фундаментальных дисциплин, калибр от решения задач большего масштаба, выносливость от регулярных тренировок. Разница в **эволюционируемости** (evolvability) как мета-характеристике.

**Why the distinction matters for the learner:**
«Хочу быстрее учиться» — плохая формулировка. Правильные формулировки:
- «Хочу поднять **показатель** скорости обучения на ближайшем горизонте» → работа M1 (собранность, слоты, методы)
- «Хочу расширить **потенциал** скорости обучения на длинном горизонте» → работа M4 (системное мышление, интеллект-стек, трансдисциплины)

**Related Items:**
- Distinction: [D.139](#d139-system-vs-characteristic) — System vs Characteristic (предшествующее различение)
- Formalization: [PD.FORM.088](../02-domain-entities/formalizations/PD.FORM.088-human-potential.md) — Потенциал человека (развёрнутая модель)
- Formalization: [PD.FORM.038](../02-domain-entities/formalizations/PD.FORM.038-productive-state-scale.md) — Шкала продуктивного состояния (показатель по одной характеристике)
- External source: Tseren, «Потенциал человека», systemsworld.club, 2025-04-28

**SoTA:** `current`
- Basis: Системная инженерия (system-of-interest × measure of effectiveness × design space); Dweck (2006) growth mindset; evolvability as meta-characteristic
- Revision criterion: Would change if potential is shown to be fully determined by genetics without developmental effect, or if the three-level distinction proves unnecessary for pedagogical guidance
