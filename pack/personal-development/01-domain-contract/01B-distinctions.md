...
| [D.150](#d150-lr-focus-vs-out-of-scope) | LR Focus vs. Out-of-Scope (Фокус программы ЛР на трёх узлах — остальное явно вне фокуса) | current | FORM.080, D.118 |
...
## [D.150] LR Focus vs. Out-of-Scope (Three Nodes) {#d150-lr-focus-vs-out-of-scope}

**Definition**: Программа Личностного Развития (ЛР) явно фокусируется на трёх областях мастерства Созидателя и явно исключает остальные. Out-of-scope — часть определения программы, не оплошность.
...
**Distinction Test**: «Можно ли пройти программу ЛР и стать профессионалом в X?» Если X = область мастерства мышления, саморазвития или управления IWE → да, это в фокусе. Если X = программирование, дизайн, медицина → нет, это профессиональное мастерство — out-of-scope.
...
**Mechanism (как ЛР влияет на каждый из 3 фокусных узлов)**:
...
- **Мастерство управления IWE** → настройка, поддержка, эволюция экзокортекса как продолжения мышления
...
| Программа ЛР фокусируется здесь | | За рамками ЛР — РР / профессиональное развитие |
