...
| PD.FORM.080 | Stage Direction Normative Matrix | FORM | Матрица нормативных состояний: 5 ступеней × 6 направлений. Две сквозные линии (Мировоззрение × Мастерство: M1 собранность, M2 инструмент, M3 проф., M4 системное мышление). Два горизонта (показатели × потенциал, FORM.088). Экономическая рамка массовой программы ЛР (10$+10ч+ЦД, см. FORM.092). Мировоззренческие критерии перехода Д→П + матрица «зачем/что/когда/как» Проактивного | draft |
...
| PD.FORM.093 | Graduate Characteristics Catalog | FORM | Каталог 8 характеристик выпускника программы ЛР: ясность, агентность, собранность, регулярность, способность производить, продуктивность, ресурсность, стрессоустойчивость. Для каждой — шкала 1-5, baseline-формула, источники данных. Матрица рычагов «мировоззрение × M1/M2/M4 × ресурсы → характеристики». Gate Проактивного: условие (1) метрический профиль ≥ baseline + условие (2) произведённое реальное изменение в ближнем круге (уровни охвата 1-2, FORM.090). Разводит характеристики выпускника (что меряем) и рычаги (на что воздействуем) — фундамент архитектуры измерений Памяти.Derived | draft |
| PD.FORM.095 | Artifact Role Accounting | FORM | Event Model для артефактов созидателя: 4 репозитория пользователя × роль исполнителя × слоты RCS. Классификатор тип-артефакта → роль → слот. Различение учебного артефакта (ДЗ, заметки) и созидательного (публикация, проект). Алгоритм автоклассификации через субагент + ручная верификация пограничных случаев. Связь с RCS (FORM.089): какой тип артефакта → какой слот M1/M2/M3/M4/W. | active |
...
> *Auto-generated by `generate-map.py` on 2026-05-04*
