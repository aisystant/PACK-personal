...
| PD.CAT.001 | Memes Catalog | CAT | Каталог непродуктивных мемов: ~45 мемов по 5 областям с антитезисами, диагностикой и методами компиляции | draft |
...
> *Auto-generated by `generate-map.py` on 2026-03-27*
