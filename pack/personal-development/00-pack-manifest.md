...
| PD.FORM.092 | Lr As Mass Program | FORM | ЛР как массовая программа: триада методология+платформа+адаптивная персонализация делает индивидуальный путь роста интеллекта масштабируемым — без наставника 1-к-1, с обещанием мировоззренческого сдвига по дуге PD.FORM.087 | draft |
