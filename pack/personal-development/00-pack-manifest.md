...
| PD.CAT.004 | Productive Memes Catalog | CAT | Каталог продуктивных мемов: seed по 5 областям (зеркало PD.CAT.001), ≥1 на область, 12 мемов. Каждый запускает метод мышления с раскрытым проверяемым основанием (D.010). Источник: продуктивные антитезисы PD.CAT.001 + реестр находок РП-333 + руководства ЛР. | draft |
