...
| PD.FORM.088 | Human Potential | FORM | Потенциал человека: расширяемый потолок шкалы характеристики. Трёхуровневая модель характеристика-показатель-потенциал. Краткосрочное движение показателей vs долгосрочное расширение потенциала через фундаментальное развитие | active |
...
> *Auto-generated by `generate-map.py` on 2026-04-20*
