...
| **Неудовлетворённость** | Психическое состояние агента — разрыв между текущим и желаемым состоянием, вызванный осознанием проблемы | «Нереализованный потенциал из-за отсутствия роста в течение 10 лет» |
...
| 2 | **Сессия стратегирования** | еженедельно (пн) | 1. План прошлой недели с итогами *(выход стадии 6)*<br>2. Реестр РП обновлённый *(выход стадии 6)*<br>3. Кэш активных РП очищенный от done *(выход стадии 6)*<br>4. Коммиты прошлой недели *(выход стадии 4)*<br>5. Мимолётные заметки накопленные *(выход стадии 1)*<br>6. Документ стратегии с текущим фокусом месяца *(выход стадии 7 или прошлой стадии 2)*<br>7. Список проектов *(стабильный, обновляется стадией 7)*<br>8. Список неудовлетворённостей *(стабильный)*<br>9. Повестка сессии (шаблон) | Ревью неудовлетворённостей; ревью прошлой недели + мультипликатор; стоп-лист по активным РП; пересмотр фокуса месяца; Note-Review по категориям; приоритизация (ТОС + отбор РП через [PD.METHOD.017](PD.METHOD.017-wp-selection.md)); инвариант «РП ≥3ч → к какому результату месяца и проекту?»; проверка связи результата с проектом; запрос недели; фиксация | План недели (новый); список неудовлетворённостей (обновлённый); документ стратегии (скорректированный фокус); кэш активных РП (полная перезапись); запись сессии |
