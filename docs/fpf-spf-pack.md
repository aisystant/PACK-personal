...
**Примечание**: Папка называется `personal-development` по историческим причинам. Доменное имя pack'а — «Характеристики и состояния созидателя». См. [01-bounded-context.md](/pack/personal-development/01-bounded-context.md).
